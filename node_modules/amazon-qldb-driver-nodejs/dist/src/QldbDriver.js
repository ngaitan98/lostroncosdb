...
var QldbSessionImpl_1 = require("./QldbSessionImpl");
/**
...
var QldbDriver = /** @class */ (function () {
     ...
     */
    function QldbDriver(ledgerName, qldbClientOptions, retryLimit) {
        ...
        this._qldbClient = new aws_sdk_1.QLDBSession(qldbClientOptions);
     ...
     * Close this driver.
     */
    QldbDriver.prototype.close = function () {
        this._isClosed = true;
    };
    /**
     ...
     */
    QldbDriver.prototype.getSession = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        logUtil_1.debug("Creating a new session.");
                        return [4 /*yield*/, Communicator_1.Communicator.create(this._qldbClient, this._ledgerName)];
                    case 1:
                        communicator = _a.sent();
                        return [2 /*return*/, new QldbSessionImpl_1.QldbSessionImpl(communicator, this._retryLimit)];
                }
            });
        });
    };
